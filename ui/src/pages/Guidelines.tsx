  ...
  return (
    <StaticPage className="page-guidelines" title="Guidelines">
      <main className="document">
        <h1>{import.meta.env.VITE_SITENAME} site guidelines</h1>
        <p>
          For the purpose of keeping this place civil and friendly, {import.meta.env.VITE_SITENAME} will have certain
        ...
        <p>
          {import.meta.env.VITE_SITENAME}, being a forum of forums, will naturally have two levels of moderation: site-wide
        ...
        <ol>
          <li>
            <strong>No spam.</strong> Sharing anything you've created or done on {import.meta.env.VITE_SITENAME} is
            completely fine but please don't repeatedly share the same link or submit to irrelevant
            communities. And don't use {import.meta.env.VITE_SITENAME} solely for self-promotion.
          </li>
          <li>
        ...
        <p>
          {import.meta.env.VITE_SITENAME} is a work in progress, and these rules are not set in stone. They may change in
