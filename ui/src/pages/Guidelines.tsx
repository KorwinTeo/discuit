...
const html = `
<h1>Linkforest site guidelines</h1>
<p>
  For the purpose of keeping this place civil and friendly, Linkforest will have certain
...
<p>
  Linkforest, being a forum of forums, will naturally have two levels of moderation: site-wide
...
<ol>
  <li>
    <strong>No spam.</strong> Sharing anything you've created or done on Linkforest is
    completely fine but please don't repeatedly share the same link or submit to irrelevant
    communities. And don't use Linkforest solely for self-promotion.
  </li>
  <li>
...
<p>
  Linkforest is a work in progress, and these rules are not set in stone. They may change in
